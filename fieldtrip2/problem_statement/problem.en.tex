...
To help the situation, you can take a candy and make an entire new kind of it by adding random ingredients (this entirely new kind is not subject to the constraint you may not put all the candy of a given kind into a single box).
